...
var _silverio$elm_prime_trees$Opt$opt = {
	trunkClr: A3(_elm_lang$core$Color$hsl, 0.3, 0.3, 0.5),
	trunkH: 80,
	trunkW1: 3,
	trunkW2: 2,
	rootH: 0,
...
var _silverio$elm_prime_trees$Msg$Resize = F2(
	function (a, b) {
		return {ctor: 'Resize', _0: a, _1: b};
	});
var _silverio$elm_prime_trees$Msg$Press = function (a) {
	return {ctor: 'Press', _0: a};
};
var _silverio$elm_prime_trees$Msg$Arrows = function (a) {
	return {ctor: 'Arrows', _0: a};
};
var _silverio$elm_prime_trees$Msg$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};

var _silverio$elm_prime_trees$Model$initModel = {num: 2, paused: false, windowWidth: 640, windowHeight: 480};
var _silverio$elm_prime_trees$Model$Model = F4(
	function (a, b, c, d) {
		return {num: a, paused: b, windowWidth: c, windowHeight: d};
	});

var _silverio$elm_prime_trees$Ptree$factorsString = function (factors) {
	return A2(
		_elm_lang$core$String$join,
		'x',
		A2(
			...
			A2(_elm_lang$core$List$drop, 1, factors)));
};
var _silverio$elm_prime_trees$Ptree$caption = F2(
	function (n, factors) {
		return _evancz$elm_graphics$Element$centered(
			A2(
				_evancz$elm_graphics$Text$height,
				_elm_lang$core$Basics$toFloat(_silverio$elm_prime_trees$Opt$opt.fontHeight),
				A2(
						...
						_evancz$elm_graphics$Text$fromString(
							A2(
								...
								_elm_lang$core$Native_Utils.eq(
									_elm_lang$core$List$length(factors),
									2) ? ' - PRIME!' : A2(
									_elm_lang$core$Basics_ops['++'],
									' = ',
									_silverio$elm_prime_trees$Ptree$factorsString(factors))))))));
	});
var _silverio$elm_prime_trees$Ptree$trunk = A2(
	_evancz$elm_graphics$Collage$filled,
	_silverio$elm_prime_trees$Opt$opt.trunkClr,
	_evancz$elm_graphics$Collage$polygon(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 0 - _silverio$elm_prime_trees$Opt$opt.trunkW1, _1: 0},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 0 - _silverio$elm_prime_trees$Opt$opt.trunkW2, _1: _silverio$elm_prime_trees$Opt$opt.trunkH},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: _silverio$elm_prime_trees$Opt$opt.trunkW2, _1: _silverio$elm_prime_trees$Opt$opt.trunkH},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: _silverio$elm_prime_trees$Opt$opt.trunkW1, _1: 0},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 0, _1: 0 - _silverio$elm_prime_trees$Opt$opt.rootH},
							_1: {ctor: '[]'}
						}
					}
				}
...
var _silverio$elm_prime_trees$Ptree$fruitGrad = function (h) {
	return A5(
		...
		16,
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 0,
				_1: A3(_elm_lang$core$Color$hsl, h, _silverio$elm_prime_trees$Opt$opt.fruitSaturation, _silverio$elm_prime_trees$Opt$opt.fruitLightness + 0.2)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 1,
					_1: A3(_elm_lang$core$Color$hsl, h, _silverio$elm_prime_trees$Opt$opt.fruitSaturation, _silverio$elm_prime_trees$Opt$opt.fruitLightness)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _silverio$elm_prime_trees$Ptree$fruit = function (h) {
	return A2(
		_evancz$elm_graphics$Collage$gradient,
		_silverio$elm_prime_trees$Ptree$fruitGrad(h),
		_evancz$elm_graphics$Collage$circle(_silverio$elm_prime_trees$Opt$opt.fruitR));
};
var _silverio$elm_prime_trees$Ptree$primeFactors = F2(
	function (n, s) {
		primeFactors:
		while (true) {
			if (_elm_lang$core$Native_Utils.cmp(s * s, n) > 0) {
				return {
					ctor: '::',
					_0: n,
					_1: {ctor: '[]'}
				...
				if (_elm_lang$core$Native_Utils.eq(
					A2(_elm_lang$core$Basics_ops['%'], n, s),
					0)) {
					return {
						ctor: '::',
						_0: s,
						_1: A2(_silverio$elm_prime_trees$Ptree$primeFactors, (n / s) | 0, s)
					};
				} else {
					if (_elm_lang$core$Native_Utils.eq(s, 2)) {
						var _v0 = n,
							_v1 = s + 1;
						n = _v0;
						s = _v1;
...
var _silverio$elm_prime_trees$Ptree$primes = function (n) {
	return {
		ctor: '::',
		_0: 1,
		_1: A2(_silverio$elm_prime_trees$Ptree$primeFactors, n, 2)
	};
};
var _silverio$elm_prime_trees$Ptree$goldenPhi = (137.5 / 180.0) * _elm_lang$core$Basics$pi;
var _silverio$elm_prime_trees$Ptree$branchFork = F4(
	function (n, cone, xs, i) {
		if (_elm_lang$core$Native_Utils.cmp(n, _silverio$elm_prime_trees$Opt$opt.budTreshold) < 1) {
			var fi = _elm_lang$core$Basics$toFloat(i);
			var fn = _elm_lang$core$Basics$toFloat(n);
			var branchAngle = (_elm_lang$core$Native_Utils.cmp(n, 1) < 1) ? 0 : ((_elm_lang$core$Basics$degrees(fi - ((fn - 1) / 2)) * cone) / (fn - 1));
			return A2(
				...
				_evancz$elm_graphics$Collage$group(
					{
						ctor: '::',
						_0: _silverio$elm_prime_trees$Ptree$trunk,
						_1: {
							ctor: '::',
							_0: A2(
								_evancz$elm_graphics$Collage$scale,
								_silverio$elm_prime_trees$Opt$opt.nestScale,
								A2(
									_evancz$elm_graphics$Collage$moveY,
									_silverio$elm_prime_trees$Opt$opt.trunkH,
									A3(_silverio$elm_prime_trees$Ptree$subTree, cone, xs, i))),
							_1: {ctor: '[]'}
						}
					}));
		} else {
			var ang = _silverio$elm_prime_trees$Ptree$goldenPhi * _elm_lang$core$Basics$toFloat(i);
			var r = _elm_lang$core$Basics$sqrt(ang) * _silverio$elm_prime_trees$Opt$opt.budSpread;
			return A2(
				_evancz$elm_graphics$Collage$moveY,
				_silverio$elm_prime_trees$Opt$opt.budOffs,
				A2(
					_evancz$elm_graphics$Collage$rotate,
					ang,
					_evancz$elm_graphics$Collage$group(
						{
							...
							_0: A2(
								_evancz$elm_graphics$Collage$scale,
								_silverio$elm_prime_trees$Opt$opt.nestScale * 0.5,
								A2(
									_evancz$elm_graphics$Collage$moveY,
									r,
									A3(_silverio$elm_prime_trees$Ptree$subTree, cone, xs, i))),
...
var _silverio$elm_prime_trees$Ptree$subTree = F3(
	function (cone, s, i) {
		var _p0 = s;
		if (_p0.ctor === '::') {
			var _p1 = _p0._0;
			return _evancz$elm_graphics$Collage$group(
				A2(
					_elm_lang$core$List$map,
					A3(_silverio$elm_prime_trees$Ptree$branchFork, _p1, cone * _silverio$elm_prime_trees$Opt$opt.coneDamping, _p0._1),
					A2(_elm_lang$core$List$range, 0, _p1 - 1)));
		} else {
			return _silverio$elm_prime_trees$Ptree$fruit(
				(_silverio$elm_prime_trees$Opt$opt.fruitHueScale * _elm_lang$core$Basics$toFloat(i)) + _silverio$elm_prime_trees$Opt$opt.fruitHueOffs);
		}
	});
var _silverio$elm_prime_trees$Ptree$ptree = F2(
	function (factors, _p2) {
		var _p3 = _p2;
		var _p5 = _p3._0;
		var _p4 = _p3._1;
		return A3(
			...
			_p4,
			{
				...
				_0: A2(
					_evancz$elm_graphics$Collage$scale,
					_elm_lang$core$Basics$toFloat(
						A2(_elm_lang$core$Basics$min, _p4, _p5)) / _elm_lang$core$Basics$toFloat(_silverio$elm_prime_trees$Opt$opt.refH),
					A2(
						_evancz$elm_graphics$Collage$moveY,
						_elm_lang$core$Basics$toFloat(((0 - _p4) / 2) | 0),
						A3(_silverio$elm_prime_trees$Ptree$subTree, _silverio$elm_prime_trees$Opt$opt.branchCone, factors, 0))),
				_1: {ctor: '[]'}
			});
	});
var _silverio$elm_prime_trees$Ptree$primeView = function (_p6) {
	var _p7 = _p6;
	var _p9 = _p7.windowWidth;
	var _p8 = _p7.num;
	var factors = _silverio$elm_prime_trees$Ptree$primes(_p8);
	return A2(
			...
			_0: _evancz$elm_graphics$Element$toHtml(
				A2(
					...
					_evancz$elm_graphics$Element$down,
					{
						ctor: '::',
						_0: A2(
							_evancz$elm_graphics$Element$width,
							_p9,
							A2(_silverio$elm_prime_trees$Ptree$caption, _p8, factors)),
						_1: {
							ctor: '::',
							_0: _evancz$elm_graphics$Element$layers(
								{
									ctor: '::',
									_0: A2(
										_silverio$elm_prime_trees$Ptree$ptree,
										factors,
										{ctor: '_Tuple2', _0: _p9, _1: _p7.windowHeight - _silverio$elm_prime_trees$Opt$opt.captionHeight}),
									_1: {
										ctor: '::',
										_0: A2(
											_evancz$elm_graphics$Element$width,
...
var _silverio$elm_prime_trees$Main$update = F2(
	function (msg, model) {
		return {
			ctor: '_Tuple2',
			_0: function () {
						...
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								num: A2(
									_elm_lang$core$Basics$max,
									2,
									A2(_elm_lang$core$Basics_ops['%'], (model.num + _p0._0.x) + _p0._0.y, _silverio$elm_prime_trees$Opt$opt.maxNum))
							});
					case 'Press':
						if (_p0._0 === 32) {
							return _elm_lang$core$Native_Utils.update(
					...
					case 'Tick':
						return _elm_lang$core$Native_Utils.update(
							model,
							{
								num: A2(
									_elm_lang$core$Basics_ops['%'],
									model.num + (model.paused ? 0 : 1),
									_silverio$elm_prime_trees$Opt$opt.maxNum)
							});
					default:
						return _elm_lang$core$Native_Utils.update(
							model,
...
var _silverio$elm_prime_trees$Main$subs = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * _silverio$elm_prime_trees$Opt$opt.animDelay, _silverio$elm_prime_trees$Msg$Tick),
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$presses(
					function (code) {
						return _silverio$elm_prime_trees$Msg$Press(code);
					}),
				_1: {
					ctor: '::',
					_0: _elm_lang$window$Window$resizes(
						function (_p1) {
							var _p2 = _p1;
							return A2(_silverio$elm_prime_trees$Msg$Resize, _p2.height, _p2.width);
						}),
					_1: {ctor: '[]'}
				}
			}
...
var _silverio$elm_prime_trees$Main$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: _silverio$elm_prime_trees$Model$initModel, _1: _elm_lang$core$Platform_Cmd$none},
		update: _silverio$elm_prime_trees$Main$update,
		view: _silverio$elm_prime_trees$Ptree$primeView,
		subscriptions: _silverio$elm_prime_trees$Main$subs
	})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _silverio$elm_prime_trees$Main$main !== 'undefined') {
    _silverio$elm_prime_trees$Main$main(Elm['Main'], 'Main', undefined);
}
